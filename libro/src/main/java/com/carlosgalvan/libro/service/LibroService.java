...
public class LibroService {
	...
	public Libro getLibroById(Long id) {
		...
		return libroRepository.findById(id)
				.orElseThrow(() -> new LibroNoEncontradoException("No se encontró el libro con el Id: " + id));
	}
	...
	public Libro updateLibro(Libro libro) {
	    ...
	    Libro existente = libroRepository.findById(libro.getId())
	        .orElseThrow(() -> new LibroNoEncontradoException("No existe el libro con el Id: " + libro.getId()));
